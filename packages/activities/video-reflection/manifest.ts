...
// Component's typed props (ActivityProps<VideoReflectionConfig>) are stricter
...
export const activity: ActivityManifest<"video-reflection"> = {
  kind: "video-reflection",
  schema: VideoReflectionConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
