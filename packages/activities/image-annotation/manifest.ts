...
// Component's typed props (ActivityProps<ImageAnnotationConfig>) are
...
export const activity: ActivityManifest<"image-annotation"> = {
  kind: "image-annotation",
  schema: ImageAnnotationConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
