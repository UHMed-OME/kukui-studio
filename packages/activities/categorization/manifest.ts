...
// Component's typed props (ActivityProps<CategorizationConfig>) are stricter
...
export const activity: ActivityManifest<"categorization"> = {
  kind: "categorization",
  schema: CategorizationConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
