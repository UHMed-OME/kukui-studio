...
import { LabPanelConfigSchema } from "./schema.js";
import uiSchema from "./ui-schema.js";
import starter from "./starter.js";
import { Icon } from "./icon.js";
import { label, description, bloom, live } from "./meta.js";

// Component's typed props (ActivityProps<LabPanelConfig>) are stricter than
...
export const activity: ActivityManifest<"lab-panel"> = {
  kind: "lab-panel",
  schema: LabPanelConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
