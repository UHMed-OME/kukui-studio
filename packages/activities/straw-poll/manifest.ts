...
import { StrawPollConfigSchema } from "./schema.js";
import uiSchema from "./ui-schema.js";
import starter from "./starter.js";
import { Icon } from "./icon.js";
import { label, description, bloom, live } from "./meta.js";

// Component's typed props (ActivityProps<StrawPollConfig>) are stricter
...
export const activity: ActivityManifest<"straw-poll"> = {
  kind: "straw-poll",
  schema: StrawPollConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
