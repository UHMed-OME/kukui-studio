...
// Component's typed props (ActivityProps<CoursePresentationConfig>) are stricter
...
export const activity: ActivityManifest<"course-presentation"> = {
  kind: "course-presentation",
  schema: CoursePresentationConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
