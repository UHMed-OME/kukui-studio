...
// Component's typed props (ActivityProps<MatchingPairsConfig>) are stricter
...
export const activity: ActivityManifest<"matching-pairs"> = {
  kind: "matching-pairs",
  schema: MatchingPairsConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
