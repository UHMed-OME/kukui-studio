...
import { FlashcardsConfigSchema } from "./schema.js";
import uiSchema from "./ui-schema.js";
import starter from "./starter.js";
import { Icon } from "./icon.js";
import { label, description, bloom, live } from "./meta.js";

// Component's typed props (ActivityProps<FlashcardsConfig>) are stricter
...
export const activity: ActivityManifest<"flashcards"> = {
  kind: "flashcards",
  schema: FlashcardsConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
