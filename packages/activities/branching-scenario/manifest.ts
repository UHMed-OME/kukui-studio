...
// Component's typed props (ActivityProps<BranchingScenarioConfig>) are stricter
...
export const activity: ActivityManifest<"branching-scenario"> = {
  kind: "branching-scenario",
  schema: BranchingScenarioConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
