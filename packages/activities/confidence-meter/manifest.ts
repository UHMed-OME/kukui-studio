...
// Component's typed props (ActivityProps<ConfidenceMeterConfig>) are
...
export const activity: ActivityManifest<"confidence-meter"> = {
  kind: "confidence-meter",
  schema: ConfidenceMeterConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
