...
// Component's typed props (ActivityProps<AnatomyLabelingConfig>) are stricter
...
export const activity: ActivityManifest<"anatomy-labeling"> = {
  kind: "anatomy-labeling",
  schema: AnatomyLabelingConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
