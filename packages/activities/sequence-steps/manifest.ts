...
import { SequenceStepsConfigSchema } from "./schema.js";
import uiSchema from "./ui-schema.js";
import starter from "./starter.js";
import { Icon } from "./icon.js";
import { label, description, bloom, live } from "./meta.js";

// Component's typed props (ActivityProps<SequenceStepsConfig>) are stricter
...
export const activity: ActivityManifest<"sequence-steps"> = {
  kind: "sequence-steps",
  schema: SequenceStepsConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
