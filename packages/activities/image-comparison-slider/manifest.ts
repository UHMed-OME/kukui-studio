...
// Component's typed props (ActivityProps<ImageComparisonSliderConfig>) are
// stricter than ActivityManifest's Component slot (ComponentType<unknown>),
// which the engine intentionally treats as opaque — config is JSON-validated
// at the engine boundary, not statically at the manifest seam.
...
export const activity: ActivityManifest<"image-comparison-slider"> = {
  kind: "image-comparison-slider",
  schema: ImageComparisonSliderConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
