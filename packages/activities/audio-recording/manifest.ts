...
// Component's typed props (ActivityProps<AudioRecordingConfig>) are stricter
...
export const activity: ActivityManifest<"audio-recording"> = {
  kind: "audio-recording",
  schema: AudioRecordingConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
