...
// Component's typed props (ActivityProps<ReflectionPromptConfig>) are stricter
...
export const activity: ActivityManifest<"reflection-prompt"> = {
  kind: "reflection-prompt",
  schema: ReflectionPromptConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
