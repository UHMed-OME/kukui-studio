...
// Component's typed props (ActivityProps<HighlightTextConfig>) are stricter
...
export const activity: ActivityManifest<"highlight-text"> = {
  kind: "highlight-text",
  schema: HighlightTextConfigSchema,
  Component,
  uiSchema,
  starter,
  Icon,
